...
string representation, instance counter, print_symbol,
static method for comparison, and a class method to create squares.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        using the character(s) in print_symbol.
        """
        if self.__width == 0 or self.__height == 0:
            return ""
